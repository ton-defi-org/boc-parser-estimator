...
export const BocExample = ( props: any) => {
    ...
    return (
        <div className="border-b">
            <h2>Boc Examples</h2>
            <div onClick={onclick.bind(null, BOC_REGULAR_TX)} className="boc-button">boc empty</div>
            <div onClick={onclick.bind(null, BOC_WITH_STATE_INIT)} className="boc-button">boc boc-state-init</div>
            <div onClick={onclick.bind(null, DEPLOY_JETTON)} className="boc-button">Deploy Jetton</div>
            <div onClick={onclick.bind(null, SWAP_JETTON_TON)} className="boc-button">SWAP TON</div>
            <div onClick={onclick.bind(null, SWAP_TON_JETTON)} className="boc-button">SWAP JETTON</div>
        </div>   )
}